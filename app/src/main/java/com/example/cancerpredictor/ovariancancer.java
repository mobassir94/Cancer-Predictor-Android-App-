...
public class ovariancancer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ovarian);
        ...
        btnSubmit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    Toast.makeText(ovariancancer.this, "Using Machine Learning Algorithms For prediction ", Toast.LENGTH_LONG).show();
                    cls = (Classifier) read(getAssets().open("logistic.model"));
                    ...
                    bundle.putDoubleArray("logistic",distribution);
                    ...
                    Intent myPred = new Intent(ovariancancer.this,predictions.class);
                    ...
                    Toast.makeText(ovariancancer.this, "Error: " + String.valueOf(e) , Toast.LENGTH_LONG).show();
                }
